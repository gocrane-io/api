...
type NodePredictionResourceSpec struct {
	...
	// MetricPredictionAlgorithm is the prediction configs of metric. each metric has its config for different prediction behaviors
	MetricPredictionAlgorithms []PredictionAlgorithm `json:"metricPredictionConfigs,omitempty"`
}
...
type PodGroupPredictionSpec struct {
	...
	PredictionAlgorithms []PredictionAlgorithm `json:"predictionAlgorithms,omitempty"`
}
