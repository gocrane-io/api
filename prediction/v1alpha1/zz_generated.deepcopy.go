...
func (in *NodePredictionResourceSpec) DeepCopyInto(out *NodePredictionResourceSpec) {
	*out = *in
	...
	if in.MetricPredictionAlgorithms != nil {
		in, out := &in.MetricPredictionAlgorithms, &out.MetricPredictionAlgorithms
		*out = make([]PredictionAlgorithm, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *PodGroupPredictionSpec) DeepCopyInto(out *PodGroupPredictionSpec) {
	*out = *in
	...
	if in.PredictionAlgorithms != nil {
		in, out := &in.PredictionAlgorithms, &out.PredictionAlgorithms
		*out = make([]PredictionAlgorithm, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
